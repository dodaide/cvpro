...
import demoImg from "./imgs/User_font_awesome.svg.png"
...
var preRotateValue=0;
function rotate(){
    foto.rotate(preRotateValue+90);
    preRotateValue += 90;
}
...
function complete(){
    var over = document.getElementById("white-overlay");
    var source =  document.getElementById("foto-image").src;
    document.getElementById('perInf--img').src = source;
    var jsonAvatar = JSON.stringify(source);
    localStorage.setItem('avatar',jsonAvatar);
    over.style.display = "none";
}

function WhiteOverlay() {
    return (
        <div style={{animation: "appear 0.5s ease"}} id="white-overlay" className="container-fluid">
            <div className="container modal--container">
                <p className="modal--title">Chỉnh sửa ảnh đại diện</p>
                <div className="modal-bodyWhite">
                    <div className="row">
                        <div className="col-md-6">
                            <div className="file-upload-section btn" onClick={selectImage}>
                                <input
                                    type="file"
                                    id="foto-file"
                                />
                    ...
                    <div className="row">
                        <div className="col-md-6 btnList--imgEditor">
                            <div className="img-container">
                                <img id="foto-image" src={demoImg} className="image"/>
                            </div>
                        </div>
                        <div className="col-md-6" >
                            <div className="row"> 
                                <div className="col-md-4 btnList--imgEditor">
                                    <p className="btnList--imgEditor--title">Xoay lật</p>
                                    <button onClick={rotate} className="btn btn--imgEditor">Xoay 90</button>
                                    <button onClick={flipVertically} className="btn btn--imgEditor">Lật dọc</button>
                                    <button onClick={flipHorizontally} className="btn btn--imgEditor">Lật ngang</button>
                                </div>
                                <div className="col-md-8 btnList--imgEditor">
                                    <p className="btnList--imgEditor--title">Hiệu ứng</p>
                                    <div className="row">
                                        <div className="col-md-6">
                                            <button onClick={makeGrayScale} className="btn btn--imgEditor">Đen trắng</button>
                                            <button onClick={makeEmboss} className="btn btn--imgEditor">Nổi khối</button>
                                            <button onClick={makeSharp} className="btn btn--imgEditor">Sắc nét</button>
                                        </div>
                                        <div className="col-md-6">
                                            <button onClick={applyCustom} className="btn btn--imgEditor">Cạnh nổi</button>
                                            <button onClick={openColorpicker} className="btn btn--imgEditor">
                                                Tô màu
                                                <input type="color" id="color-picker" onInput={makeColorize}/>
                                            </button>
                                            <button onClick={openColorizeColorPicker} className="btn btn--imgEditor">
                                                Lọc màu
                                                <input type="color" id="colorize-color-picker" onInput={applyColorFilter}/>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="file-upload-section btn" onClick={download}>
                                Tải xuống
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="file-upload-section btn" onClick={complete}>
                                Hoàn tất
                            </div>
                        </div>
                    </div>
